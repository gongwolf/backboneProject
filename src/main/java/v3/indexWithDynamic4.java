...
public class indexWithDynamic4 {
    ...
    public static void main(String args[]) throws CloneNotSupportedException {
        ...
        indexWithDynamic4 index = new indexWithDynamic4();
        index.build();
...
//        String sub_db_name = graphsize + "_" + degree + "_" + dimension + "_Level" + currentLevel;
        ...
        System.out.println("There are number of nodes " + cn + " and number of edges " + numberOfEdges);
        neo4j.closeDB();
