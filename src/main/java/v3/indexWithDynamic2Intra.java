...
public class indexWithDynamic2Intra {
    ...
    public static void main(String args[]) throws CloneNotSupportedException {
        indexWithDynamic2Intra index = new indexWithDynamic2Intra();
        index.build();
    }
                ...
                if (layer_index.get(nid) != null) { // if nid has highway information
                    for (long sid : layer_index.get(nid).keySet()) { //sid is nid's highway nods.
                        if (nodesToHighWay.get(sid) != null) {
                            ...
                            if (nodesToHighWay.get(sid).isEmpty()) { //after removed, sid is not a highway of any node. remove it.
